...
object DatabaseClone {
  given encoderDatabaseClone: Encoder[DatabaseClone] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderDatabaseClone: Decoder[DatabaseClone] = Decoder.instance { c =>
    for {
