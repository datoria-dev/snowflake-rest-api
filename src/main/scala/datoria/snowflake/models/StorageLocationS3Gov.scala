...
/** 
  ...
  * @param encryption 
  */
case class StorageLocationS3Gov(
...
object StorageLocationS3Gov {
  given encoderStorageLocationS3Gov: Encoder[StorageLocationS3Gov] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderStorageLocationS3Gov: Decoder[StorageLocationS3Gov] = Decoder.instance { c =>
    for {
