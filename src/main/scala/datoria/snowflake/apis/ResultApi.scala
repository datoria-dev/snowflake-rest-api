...
trait ResultApiEndpoints[F[*]] {

  def fetchResult(resultHandler: String, page: Option[Long] = None): F[Unit]

}

class ResultApiEndpointsImpl[F[*]: Concurrent](
  override val baseUrl: Uri,
  defaultHeaders: Seq[(String, String)] = Nil,
  httpClient: Http4sClient[F]
) extends BaseClient[F](baseUrl, defaultHeaders, httpClient) with ResultApiEndpoints[F] {
  
  import JsonSupports.*
  import io.circe.syntax.EncoderOps
  import cats.implicits.toFlatMapOps

  override def fetchResult(resultHandler: String, page: Option[Long] = None): F[Unit] = {
    ...
    _executeRequest[Unit, Unit](
      method = "GET",
      path = s"/api/v2/results/${resultHandler}",
      body = None,
      formParameters = None,
      ...
      auth = None) {
        ...
        case r if r.status.code == 202 => parseJson[F, Unit]("Unit", r)
