...
import datoria.snowflake.models.View
import datoria.snowflake.models.*

trait ViewApiEndpoints[F[*]] {

  def createView(database: String, schema: String, view: View, createMode: Option[CreateUserCreateModeParameter] = None, copyGrants: Option[Boolean] = None): F[SuccessResponse]
  def deleteView(database: String, schema: String, name: String, ifExists: Option[Boolean] = None): F[SuccessResponse]
  def fetchView(database: String, schema: String, name: String): F[View]
  def listViews(database: String, schema: String, like: Option[String] = None, startsWith: Option[String] = None, showLimit: Option[Int] = None, fromName: Option[String] = None, deep: Option[Boolean] = None): F[Seq[View]]

}

class ViewApiEndpointsImpl[F[*]: Concurrent](
  override val baseUrl: Uri,
  defaultHeaders: Seq[(String, String)] = Nil,
  httpClient: Http4sClient[F]
) extends BaseClient[F](baseUrl, defaultHeaders, httpClient) with ViewApiEndpoints[F] {
  
  import JsonSupports.*
  import io.circe.syntax.EncoderOps
  import cats.implicits.toFlatMapOps

  override def createView(database: String, schema: String, view: View, createMode: Option[CreateUserCreateModeParameter] = None, copyGrants: Option[Boolean] = None): F[SuccessResponse] = {
    ...
    _executeRequest[View, SuccessResponse](
      method = "POST",
      path = s"/api/v2/databases/${database}/schemas/${schema}/views",
      body = Some(view),
      formParameters = None,
  ...
  override def deleteView(database: String, schema: String, name: String, ifExists: Option[Boolean] = None): F[SuccessResponse] = {
    val requestHeaders = Seq(
      Some("Content-Type" -> "application/json")
    ).flatten
    val queryParameters = (
    ...
    _executeRequest[Unit, SuccessResponse](
      method = "DELETE",
      path = s"/api/v2/databases/${database}/schemas/${schema}/views/${name}",
      body = None,
      formParameters = None,
      queryParameters = queryParameters,
      requestHeaders = requestHeaders,
  ...
  override def fetchView(database: String, schema: String, name: String): F[View] = {
    val requestHeaders = Seq(
      Some("Content-Type" -> "application/json")
    ).flatten

    _executeRequest[Unit, View](
      method = "GET",
      path = s"/api/v2/databases/${database}/schemas/${schema}/views/${name}",
      body = None,
      formParameters = None,
      ...
      auth = None) {
        ...
        case r if r.status.code == 200 => parseJson[F, View]("View", r)
        case r if r.status.code == 202 => parseJson[F, View]("View", r)
        case r if r.status.code == 400 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 401 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 403 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 404 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
  ...
  override def listViews(database: String, schema: String, like: Option[String] = None, startsWith: Option[String] = None, showLimit: Option[Int] = None, fromName: Option[String] = None, deep: Option[Boolean] = None): F[Seq[View]] = {
    val requestHeaders = Seq(
      Some("Content-Type" -> "application/json")
    ).flatten
    val queryParameters = (
    ...
    _executeRequest[Unit, Seq[View]](
      ...
      auth = None) {
        ...
        case r if r.status.code == 200 => parseJson[F, Seq[View]]("Seq[View]", r)
        case r if r.status.code == 202 => parseJson[F, Seq[View]]("Seq[View]", r)
        case r if r.status.code == 400 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 401 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 403 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 404 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
