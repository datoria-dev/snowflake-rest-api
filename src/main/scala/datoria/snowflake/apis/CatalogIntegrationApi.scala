...
import datoria.snowflake.models.CatalogIntegration
...
trait CatalogIntegrationApiEndpoints[F[*]] {

  def createCatalogIntegration(catalogIntegration: CatalogIntegration, createMode: Option[CreateUserCreateModeParameter] = None): F[SuccessResponse]
  def deleteCatalogIntegration(name: String, ifExists: Option[Boolean] = None): F[SuccessResponse]
  def fetchCatalogIntegration(name: String): F[CatalogIntegration]
  def listCatalogIntegrations(like: Option[String] = None): F[Seq[CatalogIntegration]]

}

class CatalogIntegrationApiEndpointsImpl[F[*]: Concurrent](
  override val baseUrl: Uri,
  defaultHeaders: Seq[(String, String)] = Nil,
  httpClient: Http4sClient[F]
) extends BaseClient[F](baseUrl, defaultHeaders, httpClient) with CatalogIntegrationApiEndpoints[F] {
  
  import JsonSupports.*
  import io.circe.syntax.EncoderOps
  import cats.implicits.toFlatMapOps

  override def createCatalogIntegration(catalogIntegration: CatalogIntegration, createMode: Option[CreateUserCreateModeParameter] = None): F[SuccessResponse] = {
    ...
    _executeRequest[CatalogIntegration, SuccessResponse](
      method = "POST",
      path = s"/api/v2/catalog-integrations",
      body = Some(catalogIntegration),
      formParameters = None,
  ...
  override def deleteCatalogIntegration(name: String, ifExists: Option[Boolean] = None): F[SuccessResponse] = {
    val requestHeaders = Seq(
      Some("Content-Type" -> "application/json")
    ).flatten
    val queryParameters = (
    ...
    _executeRequest[Unit, SuccessResponse](
      method = "DELETE",
      path = s"/api/v2/catalog-integrations/${name}",
      body = None,
      formParameters = None,
      queryParameters = queryParameters,
      requestHeaders = requestHeaders,
  ...
  override def fetchCatalogIntegration(name: String): F[CatalogIntegration] = {
    val requestHeaders = Seq(
      Some("Content-Type" -> "application/json")
    ).flatten

    _executeRequest[Unit, CatalogIntegration](
      method = "GET",
      path = s"/api/v2/catalog-integrations/${name}",
      body = None,
      formParameters = None,
      ...
      auth = None) {
        ...
        case r if r.status.code == 200 => parseJson[F, CatalogIntegration]("CatalogIntegration", r)
        case r if r.status.code == 202 => parseJson[F, CatalogIntegration]("CatalogIntegration", r)
        case r if r.status.code == 400 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 401 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 403 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 404 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
  ...
  override def listCatalogIntegrations(like: Option[String] = None): F[Seq[CatalogIntegration]] = {
    val requestHeaders = Seq(
      Some("Content-Type" -> "application/json")
    ).flatten
    val queryParameters = (
    ...
    _executeRequest[Unit, Seq[CatalogIntegration]](
      method = "GET",
      path = s"/api/v2/catalog-integrations",
      body = None,
      formParameters = None,
      ...
      auth = None) {
        ...
        case r if r.status.code == 200 => parseJson[F, Seq[CatalogIntegration]]("Seq[CatalogIntegration]", r)
        case r if r.status.code == 202 => parseJson[F, Seq[CatalogIntegration]]("Seq[CatalogIntegration]", r)
        case r if r.status.code == 400 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 401 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 403 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
        case r if r.status.code == 404 => parseJson[F, ErrorResponse]("ErrorResponse", r).flatMap(res => Concurrent[F].raiseError(_FailedRequest(r.status.code, r.status.reason, Some(res.asJson))))
